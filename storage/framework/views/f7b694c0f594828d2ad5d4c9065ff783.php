...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.HomeLayout','data' => ['title' => $title,'time' => $time,'adminpath' => $adminpath]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                ...
                <div class="col-xl-9"
                    ...
                    <div class="row">
                        <div class="col-8 ">
                            ...
                            <div class="row">
                                <div class="col-12" style="border-radius: 4px; overflow: hidden">
                        ...
                        <div class="col-4 ">
                            <ul>
                                ...
                                <li style=" margin-bottom: 8px">
                                    <a href="/"
                                        style=" vertical-align: top; display: inline-block; width: 40%; height: 68px">
                                        <img alt="a" class="border" style="width: 100%;height: 100%"
                                            src="/images/mark-zuckerberg-1644293841385-16442938420702071314982-0-191-750-1391-crop-16442943967191483993240.png" />

                                    </a>
                                    <a href="/" class="title4"
                                        style=" display: inline-block; width: 60%;padding: 0 6px">
                                ...
                                <li style=" margin-bottom: 8px">
                                    <a href="/"
                                        style="vertical-align: top; display: inline-block; width: 40%;height: 68px; position: relative">
                                        <img alt="a" class="border" style="width: 100%;height: 100%"
                                            src="/images/mark-zuckerberg-1644293841385-16442938420702071314982-0-191-750-1391-crop-16442943967191483993240.png" />
                                ...
                                <li style=" margin-bottom: 8px">
                                    ...
                                    <a href="/" class="title4"
                                        style=" display: inline-block; width: 60%;padding: 0 6px">
                                        hot girl tram anh noi nhu con lao !!"col-3"
                ...
                <div class="col-12">
                    ...
                    <ul class="row">
                        <li class="col-3">
                            ...
                            <a href="/" class="title3"
                                style=" display:inline-block; width: 100%; padding: 0  0 0 8px">
        ...
        <section>
            <div class="row" style="margin-bottom: 40px">
                <div class="col-8 ">
                    ...
                    <div class="special" style="margin-bottom: 36px;padding: 24px">
                        <div style=" vertical-align: top; display: inline-block; width: 36%">
                            <a href="/" style="width: 100%;height: 100%">
                    ...
                    <div>
                        ...
                        <div class='row' style=" margin-bottom: 36px">
                            <div class='col-8'>
                                ...
                                <div style="display: inline-block; width: 64%;padding: 0  0 0 8px">
                                    <a href="/" class="title3">
...
<?php endif; ?>
<?php /**PATH C:\Apache24\htdocs\laravel-app\resources\views/home.blade.php ENDPATH**/ ?>