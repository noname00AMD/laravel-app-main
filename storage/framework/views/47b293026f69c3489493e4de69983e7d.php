...
<div class="col-9 start-4 newarticle" id="newarticle">
...
function ImgInput(props) {
    ...
    return (<React.Fragment>
        ...
        <div className="dropbox" ref={dropboxRef} onDrop={drop} onDragOver={dragover} onDragEnter={dragover} >
            {
                props.type === "media" ?
                    <input ref={imgRef} multiple onChange={changeImg} required accept="image/*" type="file" name="Img" className="Img" />
                    :
                    <input ref={imgRef} onChange={changeImg} required accept="image/*" type="file" name="Img" className="Img" />
            }

            <p >Drop image here ...</p>
            <div ref={reviewRef} className="preview"></div>
        </div>
